...
def display_column(col=0,height=0.0,color=colors.Blue):
	...
	logging.debug('display_column col: ' + str(col), " height" + str(height))
	...
	if col == 0:			
		...
		led.fill(color,125,125+int(round(height*25)))	
...
def main():
    ...
    logging.basicConfig(filename='/home/pi/music_and_lights.play.dbg',
    ...
    logging.debug("sample_rate " + str(sample_rate) + " num_channels " + str(num_channels))
